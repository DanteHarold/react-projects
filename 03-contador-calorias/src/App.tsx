...
import { activityReducer, inititalState } from "./reducers/activity-reducer";
import ActitvityList from "./components/ActitvityList";
  ...
  return (
    <>
      ...
      <section className="p-10 mx-auto max-w-4xl">
        <ActitvityList activities={state.activities} dispatch={dispatch} />
      </section>
    </>
  );
}
